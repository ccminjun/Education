...
namespace KFQS_Form
{
    public partial class BM_Inspection : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void BM_Inspection_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "INSPCODE"  , "검사코드"   , true, GridColDataType_emu.VarChar, 80, 120, Infragistics.Win.HAlign.Left, true, true);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "EDITOR"    , "수정자"     , true, GridColDataType_emu.VarChar, 200, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "EDITDATE"  , "수정일시"   , true, GridColDataType_emu.VarChar, 200, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAKER"     , "작성자"      , true, GridColDataType_emu.VarChar,200, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAKEDATE"  , "작성일시"   , true, GridColDataType_emu.VarChar, 200, 120, Infragistics.Win.HAlign.Left, true, false);
