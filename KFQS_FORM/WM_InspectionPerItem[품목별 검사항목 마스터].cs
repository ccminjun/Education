...
namespace KFQS_Form
{
    public partial class WM_InspectionPerItem : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void WM_InspectionPerItem_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "PLANTCODE"  , "공장"         , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , true, true);
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMCODE"   , "품목코드"     , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME"   , "품명"         , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "WHCODE"     , "창고코드"     , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "LOTNO"      , "LOTNO"        , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INSPFLAG"   , "검사필요여부" , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INSPRESULT" , "최종검사결과" , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left  , true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE"   , "품목코드"          , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE"  , "공장"              , true, GridColDataType_emu.VarChar, 130, 120, Infragistics.Win.HAlign.Left, false, false);
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                helper.Commit();
                this.ShowDialog("저장에 성공했습니다", DialogForm.DialogType.OK);
                this.ClosePrgForm();
                DoInquire();
            }
            catch (Exception ex)
