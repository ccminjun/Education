...
namespace KFQS_Form
{
    public partial class WM_Inspection : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void WM_Inspection_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMCODE", "품목", true, GridColDataType_emu.VarChar, 80, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "WHCODE", "입고창고", true, GridColDataType_emu.VarChar, 100, 120, Infragistics.Win.HAlign.Left, false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "STOCKQTY", "품목수량", true, GridColDataType_emu.VarChar, 80, 120, Infragistics.Win.HAlign.Right, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "INSPFLAG", "수입검사여부", true, GridColDataType_emu.VarChar, 100, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INSPRESULT", "검사결과", true, GridColDataType_emu.VarChar, 80, 120, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "INSPDETAIL", "검사내역", true, GridColDataType_emu.VarChar, 380, 120, Infragistics.Win.HAlign.Left, true, false);
